...
const FeedbackPage: React.FC = () => {
	...
	const feedbackMutation = useMutation({
		...
		mutationFn: async (payload: TextResponsePayload) =>
			studyApi.post<TextResponsePayload, null>('responses/texts/', payload),
		onSuccess: () => {
	...
	return (
		<div className="w-full">
			{showWarning && (
				<WarningDialog
					show={showWarning}
					confirmCallback={handleWarningConfirm}
					title="Empty feedback"
					message="<p>You hardly wrote anything.</p><p>Are you sure you are done?</p>"
			...
			<div className="w-1/3 text-left mx-auto">
				<form>
					<label htmlFor="feedbackInput">
						...
						<p className="mt-3">
							Tell us about your experience with the study. This is a research study and your feedback is
							not only important to us, but also greatly appreciated.
						</p>
						<p className="mt-3">
							You can include any suggestions, or your thoughts on the system that you interacted with.
							Your feedback will help future studies and also the design of real world systems.
						</p>
					</label>
					<textarea

...
const TestFeedbackModal: React.FC<TestFeedbackModalProps> = ({
  isOpen,
  onClose,
  studyStep,
  onShowToast,
  ...
  const feedbackMutation = useMutation({
    mutationFn: async () => {
      ...
      if (feedbackId) {
        ...
        await studyApi.patch<FeedbackPayload, void>(
        ...
        const res = await studyApi.post<FeedbackPayload, FeedbackResponse>(
          "feedbacks/",
          payload,
        );
